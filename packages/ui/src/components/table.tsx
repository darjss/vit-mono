...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-t-border font-base [&>tr]:last:border-b-0",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border text-mtext transition-colors  font-base data-[state=selected]:bg-bw data-[state=selected]:text-mtext",
      className,
    )}
    {...props}
  />
